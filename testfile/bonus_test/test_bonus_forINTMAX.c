...
//undefined but WORK: [#]
	...
	printf("  >>> printf: return value is %d\n", printf("[%0d]", 42));
	printf("\n[test 1: [-d], [-3d], 0\n");
	printf("  >>> ft_printf: return value is %d\n", ft_printf("[%-*d], [%-*d], [%*d]", 5, 42, -5, 42, -5, 42));
	printf("  >>> printf: return value is %d\n", printf("[%-*d], [%-*d], [%*d]", 5, 42, -5, 42, -5, 42));
	printf("\n[test 2: [.5d], [5.5d], 42, -42\n");
	printf("  >>> ft_printf: return value is %d\n", ft_printf("[%.5d], [%-.5d], [%.-5d], [%.*d]", 4242, 4242, 4242, -5, 4242));
	printf("  >>> printf: return value is %d\n", printf("[%.5d], [%-.5d], [%.-5d], [%.*d]", 4242, 4242, 4242, -5, 4242));
	//printf("\n[test 3: [ 3.*d], [*d], 1, 42, 5, -42\n");
	//printf("  >>> ft_printf: return value is %d\n", ft_printf("[%0d], [%-2147483648d]", 42, -42));
	//printf("  >>> printf: return value is %d\n", printf("[%0d], [%0-2147483648d]", 42, -42));
	//printf("\n[test 4: [+d], [0d], [ d], INT_MAX, INT_MIN, UINT_MAX)\n");
	//printf("  >>> ft_printf: return value is %d\n", ft_printf("[%0-2147483648d], [%.-2147483648d], [% d]", INT_MAX, INT_MIN, UINT_MAX));
	//printf("  >>> printf: return value is %d\n", printf("[%-2147483648d], [%.-2147483648d], [% d]", INT_MAX, INT_MIN, UINT_MAX));
